                          ...
                          if (formKey.currentState?.validate() ?? false) {
                            ...
                            if (mounted) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    'Room "$name" successfully created!',
                                  ),
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder:
          (context) => AlertDialog(
            ...
            content: Text(
              'Are you sure you want to delete "${room.name}"? This will also delete all instructions associated with this room.',
            ),
            actions: [
              TextButton(
      ...
      if (image != null) {
        ...
        final response = await cloudinary.uploadFile(
          CloudinaryFile.fromFile(
            file.path,
            folder:
                'buildings/${widget.building.buildingId}/floors/${widget.floorMap.floorId}',
          ),
        );
        ...
        builder: (context, snapshot) {
          ...
          return Column(
            children: [
              ...
              if (rooms.isEmpty)
                const Expanded(child: Center(child: Text('No rooms available')))
              else
                Expanded(
