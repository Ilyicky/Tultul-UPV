    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          bottom: const TabBar(
            tabs: [Tab(text: 'Buildings'), Tab(text: 'Rooms')],
          ),
        ),
        body: TabBarView(
          children: [_BookmarkedBuildingsList(), _BookmarkedRoomsList()],
        ),
      ),
    );
  }
    ...
    return StreamBuilder<List<Building>>(
      ...
      builder: (context, snapshot) {
        ...
        if (buildings.isEmpty) {
          return const Center(child: Text('No bookmarked buildings yet'));
        }
